...
{
  CxRect2 cs;
  cs.botLeft.x=MAX_MACRO(botLeft.x, r2.botLeft.x);
  cs.botLeft.y=MAX_MACRO(botLeft.y, r2.botLeft.y);
  cs.topRight.x=MIN_MACRO(topRight.x, r2.topRight.x);
  cs.topRight.y=MIN_MACRO(topRight.y, r2.topRight.y);
