...
bool CxImageGIF::Encode(CxFile * fp, CxImage ** pImages, int32_t pagecount, bool bLocalColorMap, bool bLocalDispMeth)
{
  cx_try {
	...
	if (m_loops!=1){
		ghost.SetLoops(MAX_MACRO(0,m_loops-1));
...
{
	int32_t ymin = MAX_MACRO(0,(int32_t)(GetHeight()-imgdesc.t - imgdesc.h));
	int32_t ymax = GetHeight()-imgdesc.t;
	int32_t xmin = imgdesc.l;
	int32_t xmax = MIN_MACRO(GetWidth(), (uint32_t)(imgdesc.l + imgdesc.w));
